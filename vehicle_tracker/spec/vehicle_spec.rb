require('rspec')
  ...
  describe('Vehicle') do
    ...
    # why use . instead of # i think because it does not have code to manipulate the vehicle
  describe(".all") do
   ...
   describe("#save") do
    ...
    # same as here .why use . instead of # i think because it does not have code to manipulate the vehicle (classmethod)

   describe(".clear") do
      it("empties out all of the saved vehicles") do
        Vehicle.new("Toyota", "Prius", 2000).save() #also save new instance in a line
        Vehicle.clear()
        expect(Vehicle.all()).to(eq([]))
      end
    end
    ...
    # classmethod to find an instance id of vehicle 1
    describe(".find") do
